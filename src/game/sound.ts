...
export const soundProfiles: Record<SoundCue, SoundProfile> = {
  ...
  quatroBagShake: { frequencies: [118, 146, 108, 154, 122, 164], duration: 0.72, noteLength: 0.07, gain: 0.74, type: 'triangle', stagger: 0.09 },
  quatroDeal: { frequencies: [310, 430, 320, 445], duration: 0.34, noteLength: 0.075, gain: 0.78, type: 'triangle', stagger: 0.07 },
  quatroDrop: { frequencies: [520, 330], duration: 0.23, noteLength: 0.1, gain: 0.88, type: 'triangle', stagger: 0.045 },
  quatroSwap: { frequencies: [260, 520, 610, 305], duration: 0.55, noteLength: 0.2, gain: 0.84, type: 'sine', stagger: 0.08 },
  quatroPush: { frequencies: [105, 86, 320], duration: 0.42, noteLength: 0.16, gain: 0.92, type: 'triangle', stagger: 0.055 },
  quatroMinus2: { frequencies: [420, 310, 390, 260], duration: 0.5, noteLength: 0.13, gain: 0.86, type: 'sawtooth', stagger: 0.1 },
  quatroReturn: { frequencies: [510, 390, 270], duration: 0.3, noteLength: 0.09, gain: 0.76, type: 'sine', stagger: 0.05 },
  quatroDraw: { frequencies: [240, 360, 510], duration: 0.3, noteLength: 0.09, gain: 0.78, type: 'triangle', stagger: 0.05 },
  quatroWin: { frequencies: [392, 523.25, 659.25, 783.99, 1046.5], duration: 0.82, noteLength: 0.22, gain: 0.9, type: 'triangle', stagger: 0.1 },
